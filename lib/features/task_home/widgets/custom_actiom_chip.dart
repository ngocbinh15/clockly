            ...
            child: Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final categoryEnum = TaskCategory.values.where((element) => element.displayName != "All Tasks",).toList()[index].displayName;
                  final categoryIcon = TaskCategory.values[index].icon;

                  return Obx(() {
                    final isSelected = controller.selectedAddTask.value == categoryEnum;
                      ...
                      child: GestureDetector(
                        ...
                        child: AnimatedContainer(
                          ...
                          child: Center(
                            child: Row(
                              children: [
                                HugeIcon(icon: categoryIcon, color: theme["color_border"],),
