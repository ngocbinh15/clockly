                        ...
                        onTap: () {
                          if (controller.nameController.text.isNotEmpty ||
                            ...
                            CustomDialog.confirmDialog(
                              title: "Discard draft?",
                              content:
                                  "Your changes haven’t been saved yet. Are you sure you want to discard them?",
                              cancel: "Keep editing",
                              confirm: "Discard",
                              onConfirm: () {
                                Get.back();
                      ...
                      children: [
                        ...
                        Obx(() {
                          return PrioritySelector(
                            ...
                            onChanged: (p0) =>
                                controller.selectedPriority.value = p0,
                          );
                        }),
                        ...
                        PrimaryButton(
                          text: "Save Task",
                          onPressed: () async {
                            if (controller.formStateAddTask.currentState!
                                .validate()) {
