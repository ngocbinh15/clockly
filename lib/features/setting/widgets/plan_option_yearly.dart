        ...
        child: AnimatedContainer(
          ...
          child: Column(
            ...
            children: [
              ...
              SubcriptionInfo(index: index, name: "Unlimited Tasks"),
              SubcriptionInfo(index: index, name: "Clockly AI Assistant"),
              SubcriptionInfo(index: index, name: "Advanced Analytics"),
              SubcriptionInfo(index: index, name: "Multi-device Sync"),
            ],
          ),
        ),
      );
