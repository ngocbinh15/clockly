      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: const Icon(Icons.credit_card, color: Colors.deepPurple, size: 20),
                          ),
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: const Icon(Icons.notifications_none, color: Colors.deepOrange, size: 20),
                          ),
                          const SizedBox(width: 16),
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: const Icon(Icons.palette_outlined, color: Colors.deepPurpleAccent, size: 20),
                          ),
                          const SizedBox(width: 16),
                          Expanded(
                            child: Text(
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            child: const Icon(Icons.extension_outlined, color: Colors.teal, size: 20),
                          ),
                          const SizedBox(width: 16),
            ...
            const SizedBox(height: 24),GestureDetector(
              onTap: () async {
                try {
