...
class LeaderBoard extends GetView<TeamController> {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      int currPosition =
          controller.leaderBoard.indexWhere(
            (element) => element.id == currUser.id,
          ) +
          1;
              ...
              children: [
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          "${currUser.totalPoints} Task Points",
                          style: GoogleFonts.inter(
                            color: AppColors.third,
                            fontSize: 14,
                ...
                if (currPosition <= 3)
                  Container(
                    ...
                    width: 45,
                    decoration: BoxDecoration(
                      color: colorPosition[currPosition].withValues(
                        alpha: 0.15,
                      ),
                      shape: BoxShape.circle,
                    ),
                ...
                onLongPress: () {
                  if (!isMe) {
                    CustomDialog.confirmDialog(
                      ...
                      content:
                          "Are you sure you want to remove this person from your friend list? They will be removed from your leaderboard.",
                      cancel: "Cancel",
                      confirm: "Unfriend",
                      onConfirm: () {
                        Get.back();
